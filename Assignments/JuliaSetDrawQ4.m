...
c = -0.8 + 0.4*1i; %Initializing the given constant c = -0.78 + 0.15*1i <= makes the coolst one althought the question asks for c = -0.83 + 0.2*1i;
grid = 5000; %the number of points between the limits (size of grid) 
xlims = [-0.75 , 2.5]; %The limits of he x axis
ylims = [-1.25,0.75]; %The limits of the y axis
